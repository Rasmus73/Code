...
import com.krabat.androidgames.framework.Interface.TouchHandler;
import com.krabat.androidgames.framework.impl.ObjectPool.PoolObjectFactory;
	...
	public boolean onTouch(View v, MotionEvent event)
	{
		synchronized (this)
		{
			...
			for(int ix = 0; ix < MAX_TOUCHPOINTS; ix++)
			{
				...
				{
					// If it is an up/down/cancel/out event, 
